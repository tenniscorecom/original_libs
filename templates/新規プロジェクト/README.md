...
| 読む人 | ファイル |
|---|---|
| 実行する人（毎日使う） | [使い方.md](使い方.md) |
| 保守する人（中身を直す） | [仕様書.md](仕様書.md) |
| エラーが出た人 | [ERRORS.md](ERRORS.md) |
...
4. `使い方.md` / `仕様書.md` / この README の `（ここを書く）` を埋める
5. `ERRORS.md` の「プロジェクト固有のエラー」に、このツールで起きやすいエラーを追記する
6. この節を README から削除する

コーディング規約は comken の [プロジェクト規約](../docs/プロジェクト規約.md) / [CONVENTIONS.md](../CONVENTIONS.md) に従う。
機能の探し方は [機能カタログ](../docs/機能カタログ.md)。
